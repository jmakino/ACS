...
#  end
  ...
  def help_string(option, long_flag)
    ...
    if option.type or option.longname =~ /-+-help/ or not long_flag         #20
...
def parse_command_line(def_str, variable_variables_flag = false)
  c = Clop.new(def_str, ARGV, variable_variables_flag)  
  eval(c.mk_reader)
  c
end
